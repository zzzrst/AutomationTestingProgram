namespace SeleniumUI
{
    ...
    /// </summary>
    public class ModelControler : INotifyPropertyChanged
    {
        ...
        public ButtonObject StartButton;
        ...
        {
            this.StartButton.IsObjectEnabled = false;
        ...
        {
            this.StartButton.IsObjectEnabled = true;
