// <copyright file="RunPrSQLScriptRevert.cs" company="PlaceholderCompany">
...
namespace AutomationTestingProgram.AutomationFramework
{
    ...
    /// </summary>
    public class RunPrSQLScriptRevert : TestStep
    {
        public override string Name { get; set; } = "RunPrSQLScriptRevert";
        ...
        public override void Execute()
        {
            ...
            string scriptPath = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location) + "\\scripts\\picasso_revert_template.sql";
            string tempScriptPath = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location) + "\\scripts\\temp_rev.sql";
