...
namespace AutomationTestingProgram.AutomationFramework
{
    ...
    /// </summary>
    public class LaunchTab : TestStep
    {
        /// <inheritdoc/>
        public override string Name { get; set; } = "Launch Tab";

        /// <inheritdoc/>
        public override void Execute()
        {
            Logger.Info($"Launching Tab");
            base.Execute();
            ...
            try
            {
                InformationObject.TestAutomationDriver.LaunchNewTab(url);
            ...
            {
                Logger.Error("Failed to launch tab");
